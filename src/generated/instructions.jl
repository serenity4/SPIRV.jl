...
const classes = Dict(
    ...
    OpUndef => (Symbol("Miscellaneous"), [(kind = IdResultType,), (kind = IdResult,)]),
    OpSourceContinued =>
    ...
    OpMemoryModel =>
        (Symbol("Mode-Setting"), [(kind = AddressingModel,), (kind = MemoryModel,)]),
    OpEntryPoint => (
        Symbol("Mode-Setting"),
        [
            (kind = ExecutionModel,),
    ...
    OpTypeOpaque => (
        Symbol("Type-Declaration"),
        [(kind = IdResult,), (kind = LiteralString, name = "The name of the opaque type.")],
    ),
    OpTypePointer => (
        Symbol("Type-Declaration"),
    ...
    OpGenericPtrMemSemantics => (
        Symbol("Memory"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Pointer")],
    ),
    ...
    OpDecorate =>
        (Symbol("Annotation"), [(kind = IdRef, name = "Target"), (kind = Decoration,)]),
    OpMemberDecorate => (
        Symbol("Annotation"),
        [
    ...
    OpCopyObject => (
        Symbol("Composite"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Operand")],
    ),
    OpTranspose => (
        Symbol("Composite"),
    ...
    OpConvertFToU => (
        Symbol("Conversion"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Float Value")],
    ),
    OpConvertFToS => (
        Symbol("Conversion"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Float Value")],
    ...
    OpConvertSToF => (
        Symbol("Conversion"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Signed Value")],
    ),
    OpConvertUToF => (
        Symbol("Conversion"),
        [
    ...
    OpMemoryBarrier => (
        Symbol("Barrier"),
        [(kind = IdScope, name = "Memory"), (kind = IdMemorySemantics, name = "Semantics")],
    ),
    OpAtomicLoad => (
        Symbol("Atomic"),
        [
    ...
    OpIsValidReserveId => (
        Symbol("Pipe"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Reserve Id")],
    ),
    OpGetNumPipePackets => (
        Symbol("Pipe"),
        [
    ...
    OpRetainEvent => (Symbol("Device-Side_Enqueue"), [(kind = IdRef, name = "Event")]),
    OpReleaseEvent => (Symbol("Device-Side_Enqueue"), [(kind = IdRef, name = "Event")]),
    OpCreateUserEvent =>
        (Symbol("Device-Side_Enqueue"), [(kind = IdResultType,), (kind = IdResult,)]),
    OpIsValidEvent => (
        Symbol("Device-Side_Enqueue"),
    ...
    OpCreatePipeFromPipeStorage => (
        Symbol("Pipe"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Pipe Storage")],
    ),
    ...
    OpModuleProcessed => (Symbol("Debug"), [(kind = LiteralString, name = "Process")]),
    OpExecutionModeId => (
        Symbol("Mode-Setting"),
        [(kind = IdRef, name = "Entry Point"), (kind = ExecutionMode, name = "Mode")],
    ),
    ...
    OpGroupNonUniformElect => (
        Symbol("Non-Uniform"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdScope, name = "Execution")],
    ),
    ...
    OpRayQueryTerminateKHR => (Symbol("Reserved"), [(kind = IdRef, name = "RayQuery")]),
    ...
    OpWritePackedPrimitiveIndices4x8NV => (
        Symbol("Reserved"),
        [(kind = IdRef, name = "Index Offset"), (kind = IdRef, name = "Packed Indices")],
    ),
    ...
    OpTypeVmeImageINTEL =>
        (Symbol("@exclude"), [(kind = IdResult,), (kind = IdRef, name = "Image Type")]),
    ...
    OpSubgroupAvcSicInitializeINTEL => (
        Symbol("@exclude"),
        [(kind = IdResultType,), (kind = IdResult,), (kind = IdRef, name = "Src Coord")],
    ),
