...
precompile(Tuple{typeof(AutoHashEquals.unpack_name), Expr})
precompile(Tuple{Type{Array{Symbol, 1}}})
precompile(Tuple{typeof(Base.push!), Array{Symbol, 1}, Symbol})
precompile(Tuple{typeof(AutoHashEquals.auto_hash), Symbol, Array{Symbol, 1}})
precompile(Tuple{AutoHashEquals.var"#expand#1"{Symbol, Array{Symbol, 1}}, Int64})
precompile(Tuple{typeof(AutoHashEquals.auto_equals), Symbol, Array{Symbol, 1}})
precompile(Tuple{AutoHashEquals.var"#expand#2"{Array{Symbol, 1}}, Int64})
