...
export
  ...
  TypeMap,
  SPIRType, spir_type,
  SPIR_TYPE_VOID, void_type,
  SPIR_TYPE_BOOLEAN, boolean_type,
  SPIR_TYPE_INTEGER, integer_type,
  SPIR_TYPE_FLOAT, float_type,
  SPIR_TYPE_VECTOR, vector_type,
  SPIR_TYPE_MATRIX, matrix_type,
  SPIR_TYPE_ARRAY, array_type,
  SPIR_TYPE_IMAGE, image_type,
  SPIR_TYPE_SAMPLER, sampler_type,
  SPIR_TYPE_SAMPLED_IMAGE, sampled_image_type,
  SPIR_TYPE_OPAQUE, opaque_type,
  SPIR_TYPE_STRUCT, struct_type,
  SPIR_TYPE_POINTER, pointer_type,
  SPIR_TYPE_FUNCTION, function_type,
